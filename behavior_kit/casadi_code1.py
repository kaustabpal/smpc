...
class Agent:
    ...
    def acc_bound_constraints(self):
        v1 = self.vl
        v2 = self.U[0,0]
        self.g = ca.vertcat(self.g, (v2-v1)/self.dt)
        self.lbg = ca.vertcat(self.lbg, self.amin)
        self.ubg = ca.vertcat(self.ubg, self.amax)
    ...
    def ang_acc_bound_constraints(self):
        w1 = self.wl
        w2 = self.U[1,0]
        self.g = ca.vertcat(self.g, (w2-w1)/self.dt)
        self.lbg = ca.vertcat(self.lbg, -0.1)
        self.ubg = ca.vertcat(self.ubg, 0.1)
    ...
    def pred_controls(self):
        ...
        cost_fn = self.get_goal_cost() + self.get_ang_vel_cost()
        ...
        self.acc_bound_constraints()
        self.ang_acc_bound_constraints()
